...
\author{
\IEEEauthorblockN{Jayant Shoundik\IEEEauthorrefmark{1}, [Co-Author 2]\IEEEauthorrefmark{1}, [Co-Author 3]\IEEEauthorrefmark{1}, [Co-Author 4]\IEEEauthorrefmark{1}, and [Faculty Guide Name]\IEEEauthorrefmark{2}}
...
\IEEEauthorblockA{\IEEEauthorrefmark{2}Faculty Project Supervisor, Department of Computer Science and Engineering, [Your College / University Name], [City, Country]}
...
\end{equation}
where $\sigma(x) = \frac{1}{1 + e^{-x}}$. The network is optimized via Binary Cross-Entropy with $L_2$ regularization:
\begin{equation}
...
Collaborative Filtering & 0.0014 & 0.0043 & 0.0012 & 0.0060 \\
SVD Matrix Factorization ($k=12$) & 0.0012 & 0.0037 & 0.0012 & 0.0062 \\
\textbf{SmartRecSys (Proposed)} & \textbf{0.0017} & \textbf{0.0050} & \textbf{0.0014} & \textbf{0.0070} \\
\bottomrule
\end{tabular}
\end{table}
...
\bibitem{hazar2025} M. J. Hazar, ``An Intelligent Hybrid Recommendation System for E-Learning Personalization in Smart Campus,'' \textit{IEEE Access / Springer Smart Campus Series}, vol. 13, pp. 10421--10435, 2025.
\bibitem{he2017} X. He et al., ``Neural Collaborative Filtering,'' in \textit{Proc. 26th Int. Conf. World Wide Web (WWW)}, 2017, pp. 173--182.
\bibitem{kotsiantis2012} S. B. Kotsiantis, ``Use of machine learning techniques for educational proposes,'' \textit{Artificial Intelligence Review}, vol. 37, no. 4, pp. 331--344, 2012.
\bibitem{shi2014} Y. Shi, M. Larson, and A. Hanjalic, ``Collaborative Filtering beyond the User-Item Matrix,'' \textit{ACM Comput. Surv.}, vol. 47, no. 1, art. 3, 2014.
\bibitem{liu2021} H. Liu, Z. Lin, and Y. Wang, ``Quantitative analysis of Matthew effect and sparsity problem of recommender systems,'' in \textit{Proc. IEEE Big Data}, 2021, pp. 412--419.
\bibitem{lika2014} B. Lika, K. Kolomvatsos, and S. Hadjiefthymiades, ``Facing the cold start problem in recommender systems,'' \textit{Expert Systems with Applications}, vol. 41, no. 4, pp. 2065--2073, 2014.
\bibitem{bodria2023} F. Bodria et al., ``Model-agnostic post-hoc explainability for recommender systems,'' \textit{Information Fusion}, vol. 89, pp. 450--468, 2023.
\end{thebibliography}
